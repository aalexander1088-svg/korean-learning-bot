...
async function sendRailwayHourlyWord() {
  console.log('🕐 Sending hourly Korean word via Railway...');
  ...
  try {
    ...
    console.log('✅ Hourly Korean word sent successfully via Railway!');
...
sendRailwayHourlyWord().catch(console.error);
